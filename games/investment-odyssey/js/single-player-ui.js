// Single Player UI Functions for Investment Odyssey
...
function updatePortfolioTable() {
    ...
    if (playerState.portfolioValueHistory.length <= gameState.roundNumber) {
        playerState.portfolioValueHistory.push(totalValue);
    } else {
        playerState.portfolioValueHistory[gameState.roundNumber] = totalValue;
    }
}
...
function updatePortfolioChart() {
    ...
    // Create rounds array
    const rounds = Array.from({ length: playerState.portfolioValueHistory.length }, (_, i) => i);
